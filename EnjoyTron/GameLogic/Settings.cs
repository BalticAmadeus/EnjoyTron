...
namespace GameLogic
{
    public static class Settings
    {
        ...
        public const int NextTurnPollTimeoutMillis = 2000;
        public const int ObserverPollTimeoutMillis = 2000;
        public const int MapSizeLimit = 1000;
        public const int DefaultGameTurnDurationMillis = 100;
        ...
        {
            _gameProtocolDir = ConfigurationManager.AppSettings["EnjoyTron.GameProtocolDir"] ?? _gameProtocolDir;
            _teamRegistryFile = ConfigurationManager.AppSettings["EnjoyTron.TeamRegistryFile"] ?? _teamRegistryFile;
        }
    }
}
